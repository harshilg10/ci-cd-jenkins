...
docker build -t harshilg10/cicd:latest . 
docker push harshilg10/cicd:latest

docker run -d -it --name modelv1 -p 8000:8000 harshilg10/cicd:latest bash

(modelv1: name of the container)
...
docker exec -d -w /code modelv1 uvicorn main:app --proxy-headers --host 0.0.0.0 --port 8000
